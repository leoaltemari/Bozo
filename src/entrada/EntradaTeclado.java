...
static BufferedReader br = new BufferedReader(isr);
	 ...
	 * @throws IOException
	 */
	public static int leInt() throws ETException, IOException {
		String x = leString();
		if(x.length() == 0) {
			throw new ETException("Nenhum INTEIRO foi digitado");
		}
	...
	public static double leDouble() throws ETException, IOException {
		String x = leString();
		if(x.length() == 0) {
			throw new ETException("Nenhum DOUBLE foi digitado");
		}
